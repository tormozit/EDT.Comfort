Плагин широкого назначения для **1C EDT 2025-2026**: навигация, наборы объектов, редактор BSL, отладка, сравнение конфигураций, интеграция с [Инструментами разработчика Tormozit (ИР)](https://devtool1c.ucoz.ru/).
