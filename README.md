...
В частности обеспечивает доступ к функциям подсистемы "Инструменты разработчика Tormozit" (ИР) из базы проекта.
Доступ к функциям ИР обспечивается за счет автоматического подключения через OLE (COM) служебного клиентского приложения текущей базы 1С с автоматической регистрацией COM класса нужной версии платформы (однократно могут потребоваться права администратора).
