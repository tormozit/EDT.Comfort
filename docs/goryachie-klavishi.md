...
| [Инспектировать](inspektor-peremennyh.md#inspektirovat-iz-redaktora-modulya) | Shift+F9 | редактор модуля: выделение, слово под кареткой либо пустой ввод на пустом месте (сочетание EDT) |
