...
Устранено неоправданное смещение горизонтальной полосы прокрутки при переходе к месту в модуле — например, из результатов поиска или иерархии вызовов ([#215](https://github.com/tormozit/EDT.Comfort/issues/215)).
