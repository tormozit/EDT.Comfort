...
- вложенные текстовые поля в редакторах метаданных и других частях Workbench.
...
В контекстном меню редактируемых текстовых полей Workbench — подменю **Комфорт** с пунктами **Вставить со сравнением** (в подписи указано сочетание **Ctrl+Alt+V**) и **Сортировать строки текста**.
