...
Улучшение контекстной подсказки (**content assist**) в **редакторе BSL** — модули объектов, форм, общие модули, а также поля условия и значения выражения в диалоге **«Свойства для …»** точки останова. Окно редактора модуля — см. [Редактор модуля](redaktor-modulya.md).
...
- **Редактор BSL** (модули) и поля условия / значения выражения в диалоге [точки останова](tochki-ostanova.md); другие текстовые редакторы EDT не затрагиваются (кроме [редакторов запросов](redaktor-zaprosa.md) — см. ниже).
- В полях точки останова в список не подмешиваются строки ИР — только варианты EDT с умным фильтром и автооткрытием.
