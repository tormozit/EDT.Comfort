...
## Несколько типов в комментарии «Параметры:»

Если у параметра в комментарии указано несколько типов через запятую, после точки доступны свойства и методы **всех** этих типов. **Родитель:** показывает оба имени.

```
// Параметры:
//  Форма - РасширениеФормыКлиентскогоПриложенияДляДинамическогоСписка, ФормаКлиентскогоПриложения
