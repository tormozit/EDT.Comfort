...
| Колонка «Путь» | В правой таблице — относительный путь к свойству в объекте от корня дерева; открытие вхождений схемы компоновки данных / табличного документа корректно активирует нужную страницу ([#209](https://github.com/tormozit/EDT.Comfort/issues/209)) |
