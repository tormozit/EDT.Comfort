...
- кнопка **«Сравнить ИР»** на командной панели (тексты сторон в форме ИР);
- для файлов **`.mxlx`** — дополнительно кнопка **«Сравнить таблично ИР»** (то же сравнение макетов, что и в дереве).
