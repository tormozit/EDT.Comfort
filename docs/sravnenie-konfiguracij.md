...
- Подключено [приложение ИР](obshchie-mekhanizmy.md#integraciya-s-ir) к информационной базе проекта сравнения.
- ИР установлены в базе; платформа — Windows (COM).
...
|-------------------|----------|
| **BSL-модуль** | Открывается диалог **настройки объединения / сравнения модуля** EDT (штатный merge UI) |
...
На панели редактора сравнения — кнопка-dropdown **Развернуть**:
