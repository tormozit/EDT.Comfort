...
- **Флажок «Только помеченные»** — показать только отмеченные типы. Состояние флажка запоминается и применяется сразу при открытии окна ([#250](https://github.com/tormozit/EDT.Comfort/issues/250)).
