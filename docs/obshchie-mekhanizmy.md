...
Если у списка (Table / Tree) нет штатной команды копирования, **Ctrl+C** копирует текст активной ячейки (или представление текущей строки) в буфер обмена ([#181](https://github.com/tormozit/EDT.Comfort/issues/181)).
