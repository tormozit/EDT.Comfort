...
**Где работает:** навигатор, список информационных баз, быстрая схема модуля, диалоги выбора типа и объекта метаданных, [списки автодополнения](avtodopolnenie.md), панели «Последние места» и «Наборы объектов», [панель «Результаты поиска»](rezultaty-poiska.md).
