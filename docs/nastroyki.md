...
| Серверные вызовы отдельным цветом | Визуальное выделение серверных вызовов в коде ([#66](https://github.com/tormozit/EDT.Comfort/issues/66)) |
| Отображать начало конструкции в её конце | См. [Автодополнение → Подсказка начала конструкции](avtodopolnenie.md#podskazka-nachala-konstrukcii) ([#80](https://github.com/tormozit/EDT.Comfort/issues/80)) |
