...
| Суффиксы набора 1 (через запятую) | Комбинируемые суффиксы хвоста имени (любое количество в цепочке). По умолчанию: Клиент, Сервер, ПовтИсп, ВызовСервера, Вызова, Кэш, Глобальный |
...
**Параметры → Комфорт → Направляющие отступов** — включение и оформление вертикальных линий уровней отступа в текстовых редакторах. См. [Редакторы текста → Направляющие отступов](redaktory-teksta.md#napravlyayushchie-otstupov).
