...
| Суффиксы имён общих модулей (через запятую) | Суффикс отрезается от имени модуля, чтобы получить имя группы; если подходит несколько суффиксов, применяется самый длинный |
