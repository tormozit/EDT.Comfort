 ...
 */
final class CollectionIndexColumnWidthStore
{
    private static final String PREF_WIDTH = "comfort.collection.indexColumn.width"; //$NON-NLS-1$
    ...
    private CollectionIndexColumnWidthStore() {}
    ...
    private static ScopedPreferenceStore prefs()
    {
        ...
        try
        {
            String pluginId = FrameworkUtil.getBundle(CollectionIndexColumnWidthStore.class).getSymbolicName();
