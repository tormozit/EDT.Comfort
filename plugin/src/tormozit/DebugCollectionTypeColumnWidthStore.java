 ...
 */
final class DebugCollectionTypeColumnWidthStore
{
    private static final String PREF_WIDTH = "debug.collection.typeColumn.width"; //$NON-NLS-1$
    ...
    private DebugCollectionTypeColumnWidthStore() {}
    ...
    private static ScopedPreferenceStore prefs()
    {
        ...
        try
        {
            String pluginId = FrameworkUtil.getBundle(DebugCollectionTypeColumnWidthStore.class).getSymbolicName();
