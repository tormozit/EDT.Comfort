...
/**
 * Ширина колонки «Индекс» в split-table «Коллекция» (между сеансами EDT).
 */
final class DebugCollectionIndexColumnWidthStore
{
    private static final String PREF_WIDTH = "debug.collection.indexColumn.width"; //$NON-NLS-1$
    ...
    private DebugCollectionIndexColumnWidthStore() {}
    ...
    private static ScopedPreferenceStore prefs()
    {
        ...
        try
        {
            String pluginId = FrameworkUtil.getBundle(DebugCollectionIndexColumnWidthStore.class).getSymbolicName();
