 ...
 * строки малополезен) — если само вхождение шире окна, показываем от его начала. Общая для панелей
 * "Результаты поиска" (по конфигурации — {@code ConfigSearchResultsHook}, по файлам —
 * {@code FileSearchResultsHook}).
 */
