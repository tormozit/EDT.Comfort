...
| Колонка «Путь» | В правой таблице — относительный путь к свойству в объекте от корня дерева; для **модулей форм** дописывается имя формы через точку (напр. `Документ.Имя.Форма.ФормаДокумента`) ([#247](https://github.com/tormozit/EDT.Comfort/issues/247)); открытие вхождений схемы компоновки данных / табличного документа корректно активирует нужную страницу ([#209](https://github.com/tormozit/EDT.Comfort/issues/209)) |
| Активирование поля | Открытие вхождения из таблицы устанавливает фокус на соответствующее поле в панели «Свойства» редактируемого объекта ([#230](https://github.com/tormozit/EDT.Comfort/issues/230)) |
