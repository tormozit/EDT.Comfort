...
| Состояние | Поведение |
|-----------|-----------|
| Включено (по умолчанию) | Hover-подсказка при **удержании** указателя на слове |
| Выключено | Hover только при **зажатом Ctrl** |
Режим запоминается между сеансами EDT. **Ctrl+F2** и осознанный вызов подсказки с клавиатуры не затрагиваются.
